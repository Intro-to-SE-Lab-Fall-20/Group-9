                ...
                if not email_stored: # If the email is not in the database...
                    ...
                    if msg.is_multipart():
                        ...
                        for part in msg.walk():
                            ...
                            # Download attachment and get the file path
                            if "attachment" in content_disposition:
                                has_attachment = True
                                filename = part.get_filename()
                                if filename:
                                    attach_dir_path = os.path.join(app.config['ATTACHMENT_FOLDER'], subject + "_" + date)
                                    os.mkdir(attach_dir_path)
                                    filepath = os.path.join(attach_dir_path, filename)
